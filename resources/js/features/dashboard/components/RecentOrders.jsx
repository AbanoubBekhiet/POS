...
const orders = [
    { id: '#ORD-2847', customer: 'أحمد حسن',   items: 3, total: '42.50 د.إ', status: 'completed', time: 'منذ 5 دقائق'  },
    { id: '#ORD-2846', customer: 'سارة علي',        items: 2, total: '28.00 د.إ', status: 'processing', time: 'منذ 12 دقيقة' },
    { id: '#ORD-2845', customer: 'محمد يوسف', items: 5, total: '67.80 د.إ', status: 'completed', time: 'منذ 25 دقيقة' },
    { id: '#ORD-2844', customer: 'فاطمة إبراهيم',   items: 1, total: '12.99 د.إ', status: 'pending',   time: 'منذ 32 دقيقة' },
    { id: '#ORD-2843', customer: 'عمر خالد',     items: 4, total: '55.20 د.إ', status: 'cancelled', time: 'منذ ساعة'   },
]
        ...
        <div className="rounded-2xl overflow-hidden" style={{ backgroundColor: '#FFFFFF', border: '1px solid #EAE8E2' }}>
            ...
            <div className="flex items-center justify-between p-5 sm:p-6" style={{ borderBottom: '1px solid #EAE8E2' }}>
                <div className="text-right">
                    ...
                    <p className="text-sm mt-0.5" style={{ color: '#9A978F' }}>نظرة عامة على آخر المعاملات</p>
                </div>
                ...
                <table className="w-full text-right" dir="rtl">
                    <thead>
                        <tr style={{ borderBottom: '1px solid #F4F3EF' }}>
                            {['معرف الطلب','العميل','العناصر','الإجمالي','الحالة','الوقت',''].map(h => (
                    ...
                    <div key={order.id} className="p-4 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-right" style={{ color: '#B8B5AE' }}>{order.id} · {order.items} منتجات</p>
                            </div>
                        </div>
